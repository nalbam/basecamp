...
```
  ...
  I : Iguana
  J : Jaguar
  K : Kangaroo, Koala, Killer while
  L : Lion
  M : Monkey, Mouse, Makaw
  N : Narwhal, Newt
  O : Octopus
  P : Pig, Panda, Penguin
  Q : Quail, Queen Bee
  R : Rabbit, Rhinoceros
  S : Shark, Sheep, Spider, Snake, Scorpion
  T : Turtle, Tiger, Tortoise
  U : Unicorn
