...
iptables -A INPUT -p tcp -s 1.214.48.241 --dpost 8443 -m state --state NEW,ESTABLISHED -j ACCEPT

iptables -A INPUT -p tcp --dpost 22    -m state --state NEW,ESTABLISHED -j ACCEPT
